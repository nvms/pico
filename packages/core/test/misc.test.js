...
import { parseLine, parseLines, makeEvent } from '../src/events.js'
...
test('mcp runtime merges global and project servers, scopes writes', async () => {
  const { createMcpRuntime, writeRegistry, writeProjectConfig, readProjectConfig, readRegistry } = await import('../src/mcp.js')
