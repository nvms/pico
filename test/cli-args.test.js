...
test('rejects bad input', () => {
  ...
  assert.throws(() => parseArgs(['--max-tool-calls', 'zero']), /positive integer/)
  assert.throws(() => parseArgs(['--max-tool-calls', '10foo']), /positive integer/)
  assert.throws(() => parseArgs(['--max-tool-calls', '1.5']), /positive integer/)
  assert.throws(() => parseArgs(['--max-tool-calls', '0']), /positive integer/)
  assert.throws(() => parseArgs(['--max-tool-calls', '-1']), /positive integer/)
  assert.throws(() => parseArgs(['--max-tool-calls', '9007199254740992']), /positive integer/)
